...
// Green announces a message in green
func (n *Notifier) Green(msg string) {
	fmt.Println(green(msg))
}

// Yellow announces a message in yellow
func (n *Notifier) Yellow(msg string) {
	fmt.Println(yellow(msg))
}

// Red announces a message in yellow
func (n *Notifier) Red(msg string) {
	fmt.Println(red(msg))
}
